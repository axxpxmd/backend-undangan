            ...
            <div class="col-md-9 height-full css-selector d-flex align-content-center flex-wrap">
                <div class="col-md-6">
                    <div class="text-white p-l-80">
                        <p class="fs-50 font-weight-light">Lorem Ipsum</p>
                        <p class="mt-4 fs-25 font-weight-lighter">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
